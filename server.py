...
# When deployed behind Railway's reverse proxy, FastMCP's DNS rebinding
# protection rejects the real domain in the Host header.
# We configure TransportSecuritySettings to explicitly allow the Railway host.
